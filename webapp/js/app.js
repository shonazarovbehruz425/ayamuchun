            ...
            <div class="space-y-5 animate-fade-in">
                ...
                <div>
                    ...
                    <div id="tools-grid" class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <!-- Tool 7: Extract Images from PDF -->
                        ...
                        <!-- ==================== 3. SURAT & RASM VOSITALARI (2 TA) ==================== -->
                        <!-- Tool 10: Hujjat foto (3x4) - PROMINENT HIGHLIGHT -->
                ...
                return `
                    <div class="p-3 sm:p-3.5 flex items-center justify-between hover:bg-white/70 dark:hover:bg-slate-800/60 active:bg-white/90 transition-all cursor-pointer group" onclick="openFileWorkPage(${f.id}, '${f.file_name.replace(/'/g, "\\'")}', '${ext}')">
                        ...
                        <div class="flex items-center gap-1.5 shrink-0" onclick="event.stopPropagation()">
                            ...
                            <button onclick="window.sendRecentFileToTg(${f.id})" title="Telegram chatga yuborish" class="px-2 py-1 rounded-lg liquid-glass-pill text-[11px] font-bold text-slate-600 hover:bg-white transition-colors inline-flex items-center">
